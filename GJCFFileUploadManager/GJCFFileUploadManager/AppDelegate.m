...
- (void)addDebugMoudle
{
    TVGDebugModel *item = [TVGDebugModel debugModelWithTitle:@"XXUpload" withClassName:@"GJCFXXUploadImageViewController"];
    TVGDebugSectionInfo *sectionInfo = [TVGDebugSectionInfo debugSectionInfoWithTitle:@"XXUpload" withTestsArra:@[item]];
